"""Catalogo de estadios MLB: coordenadas y park factor."""
import os
...
def obtener_coordenadas(nombre_estadio):
    coords = ESTADIOS.get(nombre_estadio)
    return coords if coords is not None else (None, None, None)